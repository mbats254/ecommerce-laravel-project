...
class Container_7287b4cf1b extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_7287b4cf1b $container)
			{
	...
	public function createServiceContainer(): Container_7287b4cf1b
	{
		return $this;
	}
